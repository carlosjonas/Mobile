...
const [troca,setTroca]=React.useState('Troca de corrente');
const [balanceamento,setBalanceamento]=React.useState('Troca de aro');
const [revisao,setRevisao]=React.useState('Revisão');

const [checkeddia, setCheckeddia]=React.useState('null');
const [segunda,setSegunda]=React.useState('Segunda');
const [terca,setTerca]=React.useState('Terça');
const [quarta,setQuarta]=React.useState('Quarta');
const [quinta,setQuinta]=React.useState('Quinta');
const [sexta,setSexta]=React.useState('Sexta');
